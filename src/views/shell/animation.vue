...
import SortHeader from "../../components/sort/modules/SortHeader";
import SortMain from "../../components/sort/modules/SortMain.vue";
import SortFooter from "../../components/sort/modules/SortFooter.vue";
export default {
	name: "ShellAnimation",
	props: {},
	components: {
			...
			if (this.sortState === 0) {
				...
				switch (line) {
					...
					case 6.3:
						if (
							less(
								this.items[current.inner],
								this.items[current.inner - current.h]
							)
						) {
